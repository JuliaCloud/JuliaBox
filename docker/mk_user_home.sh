...
cp ${DIR}/IJulia/custom.css ${JUSER_HOME}/.ipython/profile_julia/static/custom/custom.css

mkdir -p ${JUSER_HOME}/.juliabox

cp -R ${DIR}/IJulia/tornado ${JUSER_HOME}/.juliabox/tornado
cp ${DIR}/IJulia/supervisord.conf ${JUSER_HOME}/.juliabox/supervisord.conf
